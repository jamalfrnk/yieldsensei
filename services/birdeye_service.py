...
async def get_token_price(input_token: str) -> Dict:
    ...
    async def _fetch_token_price(address: str):
        ...
        url = f"{BIRDEYE_BASE_URL}/defi/token_price"
...
async def get_token_market_data(input_token: str) -> Dict:
    ...
    async def _fetch_market_data(address: str):
        ...
        price_url = f"{BIRDEYE_BASE_URL}/defi/token_price"
        price_params = {"address": address}
        
        # Get token metadata
        metadata_url = f"{BIRDEYE_BASE_URL}/defi/token_metadata"
        metadata_params = {"address": address}
        
        # Get historical price data
        ohlcv_url = f"{BIRDEYE_BASE_URL}/defi/ohlcv"
        ohlcv_params = {
            "address": address,
            "interval": "60m",  # 1 hour interval
